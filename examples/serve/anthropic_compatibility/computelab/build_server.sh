...
#   sbatch examples/serve/anthropic_compatibility/computelab/build_server.sh
...
MODEL_PATH="${MODEL_PATH:-/home/scratch.trt_llm_data/llm-models/DeepSeek-V4-Pro}"
CONTAINER_IMAGE="${CONTAINER_IMAGE:-/home/scratch.serli_gpu/workspace/containers/tensorrt-llm-pytorch-26.05-py3-x86_64-ubuntu24.04-trt10.16.1.11-skip-tritondevel-202607151440-16194.sqsh}"
PORT="${PORT:-8333}"
...
START_SCRIPT="${EXAMPLE_DIR}/computelab/start_server.sh"
