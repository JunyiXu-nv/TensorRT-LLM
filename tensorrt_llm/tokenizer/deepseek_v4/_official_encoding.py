...
#
# Vendored from DeepSeek-V4-Pro: encoding/encoding_dsv4.py
# Upstream source: https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro
# Upstream license: MIT (Copyright (c) DeepSeek)
#
# This file is included verbatim (aside from this header) so that TensorRT-LLM
# can render DSv4 chat messages with tool-calls, thinking mode, and tool-result
# messages using the official encoder. Do not edit locally; re-vendor from
# upstream if DeepSeek updates the encoding.
#
# Because this is vendored upstream code, we suppress local style checks:
# ruff: noqa
# flake8: noqa
"""
