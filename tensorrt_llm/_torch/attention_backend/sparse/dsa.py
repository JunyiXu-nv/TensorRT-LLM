...
class Indexer(nn.Module):
    ...
    def sparse_attn_indexer(
        ...
        # Skip if the caller already scattered K into the cache (e.g. via
        # _prep_k_and_scatter's fused kernel).
    ...
    def forward(self, qr: torch.Tensor, hidden_states: torch.Tensor,
        ...
        # K cache was already populated by the fused scatter in _prep_k_and_scatter,
        # so skip the redundant _update_k_cache inside sparse_attn_indexer.
